...
const Head = props => {
  ...
  return (
    <Helmet>
      ...
      <link rel="alternate" href="https://www.tandemz.io/" hreflang="x-default" />
      ...
      <meta property="og:image"        content={meta.ogimage || defaultImg} name="image" />
      <meta property="og:image:alt"    content={meta.ogimagealt || 'Tandemz Logo'} />
