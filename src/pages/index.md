...
- type: heroblock
  ...
  component: HeroBlock
  content: Sur Tandemz, lancez vos études UX en un clin d’œil. Concentrez-vous enfin
...
- template: iconsblock
  ...
  iconblocks:
  - title: UX Designer
    content: Animez votre test, analysez et partagez. Ne perdez plus de temps en organisation.
  ...
  - title: Responsable produit
    content: Permettez à votre équipe d'adopter le réflexe test utilisateur. Soyez
      sûr que votre produit soit adapté.
    icon: ''
  title: Vous êtes...
  section_id: roles
  subtitle: ''
